	          ...
	          <div class="row g-0">
	            ...
	            <div class="col-md-6 col-lg-7 d-flex align-items-center">
                  ...
                  <div align="center" class="h6 fw-bold mb-0">후기작성</div>
	                  ...
	                  <div class="form-outline mb-1">
	                  	<label class="form-label">담당산후조리사</label>
	                  <c:forEach items="${list }" var="sanmo">
	                    <input  class="form-control form-control-sm" value="${sanmo.name }" readonly="readonly" style="text-align: center;"/> 
	                    </c:forEach>  
	                  </div>	              
	                  ...
	                  <label class="form-label">입실일자</label>
	                   <input class="form-control form-control-sm" value="${sanmo.startday }"readonly="readonly" style="text-align: center; background-color: white" />
	                   <label class="form-label">퇴실일자</label>
	                   <input class="form-control form-control-sm" value="${sanmo.endday }" readonly="readonly" style="text-align: center; background-color: white" />
	                  </div>
...
<fieldset class="rating">
	    ...
	    <label class="half" for="starhalf"></label>
					...
					<div class="form-outline mb-1">
	                   ...
	                   <textarea rows="10" cols="20" class="form-control form-control-sm"></textarea>
	                  </div>
