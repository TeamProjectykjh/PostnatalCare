...
<body>
			...
			<c:forEach items="${lista}" var="list">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s" style="visibility: visible; animation-delay: 0.1s; animation-name: fadeInUp;">
                    <a style="text-decoration-line: none;" class="service-item d-block rounded text-center h-100 p-4" href="modifyshh?nurnum=${list.nurnum }&name=${list.name}">
                        <img style="object-fit: cover; height: 70%;" class="img-fluid rounded mb-4" src="nurseimg/${list.nurpath}" >
                        <h4 style="color: black" class="mb-0">${name} 간호사님</h4>
